...
const BlockchainGenesis = require('./blockchain-genesis')
...
class BlockchainDifficulty{
    ...
    static async getDifficultyMeanPOW( prevBlockDifficulty, getTimeStampCallback, blockTimestamp, blockNumber){
        ...
        //adding block 9
        console.log(`T_${blockNumber} - T_${blockNumber-1}`)
...
module.exports = BlockchainDifficulty;